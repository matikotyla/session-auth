...
export const Header = () => {
  return (
    <header className="fixed left-0 top-0 z-50 w-full animate-fade-in border-b backdrop-blur-[12px]">
      <div className="locker flex h-[--navigation-height] w-full items-center justify-between">
